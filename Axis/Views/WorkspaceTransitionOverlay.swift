...
class WorkspaceTransitionManager {
	...
	private let transitionDuration: TimeInterval = 0.26 // Natural spring / damping duration
	...
	func startTransition(from fromWS: Int, to toWS: Int, on screen: NSScreen) {
		...
		CATransaction.setAnimationTimingFunction(CAMediaTimingFunction(controlPoints: 0.22, 1.0, 0.36, 1.0)) // Damping curve
