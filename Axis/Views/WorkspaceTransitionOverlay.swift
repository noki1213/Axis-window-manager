...
class WorkspaceTransitionManager {
	...
	private let transitionDuration: TimeInterval = 0.28 // Natural spring / damping duration
	...
	func performSlideTransition(
		...
		CATransaction.setAnimationTimingFunction(CAMediaTimingFunction(controlPoints: 0.16, 1.0, 0.3, 1.0)) // Critically damped spring
